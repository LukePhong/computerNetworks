...
#ifndef TRY1_GBNRENOSENDER_H
#define TRY1_GBNRENOSENDER_H
...
class gbnRenoSender : public netBase {
private:
    bool needResend;
...
public:
    gbnRenoSender(server *theServerToServe);
...
//    void setNeedResendForDup();
    void resendEverythingInNoACKWindow();
};



#endif //TRY1_GBNRENOSENDER_H
